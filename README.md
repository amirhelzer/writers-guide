# OnTheGoSystem’s Content Writing Guide

This, not so short, guide puts together years of one-to-one training and mentoring into a document. The purpose of this guide is to help writers do a great job, develop their career and allow us and other companies like us, to succeed in the challenging world of content marketing.
...
1. Clear setup instructions, in correct and concise language and a convenient font.  
2. Instructions for how to get help, if needed.  
3. Tips on efficient usage.  
4. Tips on smart maintenance.  
5. Instructions for how to sign-up to a mailing list for people like yourself.
...
#### 1\) [Boomerang: 40M emails](https://blog.boomerangapp.com/2016/02/7-tips-for-getting-more-responses-to-your-emails-with-data/) (2016)
...
#### 2\) [Nielsen Norman Group: controlled usability experiment](https://www.nngroup.com/articles/how-users-read-on-the-web/) (1997)
...
Most decisions are made quickly, with incomplete information, and under emotional pressure. **Prospect Theory** (introduced in [Thinking Fast and Slow](https://www.amazon.com/Thinking-Fast-Slow-Daniel-Kahneman/dp/0374533555)), explains how people actually decide when there is risk, effort, or uncertainty involved.
...
#### 4\. Build relevant incoming links
...
[Google Search Console](https://search.google.com/search-console/about) (GSC) provides complete, accurate data about how your site appears in Google search results.
...
[GA](http://analytics.google.com/) and [Matomo](https://matomo.org/) track what happens after people click through from search results. They show on-page metrics covered in the previous chapter: bounce rate, time on page, conversion to your desired action.
...
#### Example 1 \- [wpml.org](http://wpml.org) (website translation, very established)
...
#### Example 2 \- [PTC.wpml.org](http://PTC.wpml.org) (software translation, new arrival)
